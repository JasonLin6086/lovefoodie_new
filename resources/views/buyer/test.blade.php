@extends('buyer.master', ['tab1' => 'test'])
...
<div class="main_title title_paddingto">
    <h2 class="nomargin_topp" style="padding-top:0">Testing Page</h2>
</div>
<form class="holder-control form-horizontal" id="info"role="form" data-toggle="validator" action="{{ url('/buyer/test') }}" method="post" enctype="multipart/form-data">
